Contributing to Grow Core
============================

The Grow Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Grow Core project, and is not to be
confused with overall GROW Network Protocol consensus changes.

Whether a pull request is merged into Grow Core rests with the project merge
...
Patches that change GROW consensus rules are considerably more involved than
...
Where a patch set proposes to change the GROW consensus, it must have been
...
The project leader is the release manager for each Grow Core release.
