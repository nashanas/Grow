#!/usr/bin/env python3
# Copyright (c) 2019 The GROW Core developers
...
from fake_stake.base_test import GROW_FakeStakeTest

class zGROWwrappedSerialsTest(GROW_FakeStakeTest):
    ...
    def run_test(self):
        ...
        # 2) Mint zerocoins
        self.log.info("Minting %d-denom zGROWs..." % DENOM_TO_USE)
