...
#ifndef GROW_ZGROWTRACKER_H
#define GROW_ZGROWTRACKER_H
...
public:
    CzGROWTracker(std::string strWalletFile);
    ~CzGROWTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzGROWWallet* zGROWWallet = NULL);
