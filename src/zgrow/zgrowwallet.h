...
#ifndef GROW_ZGROWWALLET_H
#define GROW_ZGROWWALLET_H
...
public:
    CzGROWWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZGROW(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZGROW(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
