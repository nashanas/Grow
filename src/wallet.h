...
public:
    ...
    */
    ...
    bool fBackupMints;
    std::unique_ptr<CzGROWTracker> zpivTracker;
    ...
    {
        zwalletMain = zwallet;
        zpivTracker = std::unique_ptr<CzGROWTracker>(new CzGROWTracker(strWalletFile));
    }
    ...
    void setZCstlAutoBackups(bool fEnabled)
    {
