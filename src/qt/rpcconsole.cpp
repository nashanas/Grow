                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzGROWPathCustom = GetArg("-zgrowbackuppath", "");
    ...
    if(!strzGROWPathCustom.empty()) {
        ui->wallet_customzgrowbackuppath->setText(QString::fromStdString(strzGROWPathCustom));
        ui->wallet_customzgrowbackuppath_label->setVisible(true);
        ui->wallet_customzgrowbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzGROWPathCustom.empty()) && nCustomBackupThreshold > 0) {
