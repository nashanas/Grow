...
/* Grow GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Grow"
#define QAPP_ORG_DOMAIN "projectgrow.tech"
#define QAPP_APP_NAME_DEFAULT "Grow-Qt"
#define QAPP_APP_NAME_TESTNET "Grow-Qt-testnet"
