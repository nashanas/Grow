...
UniValue getinfo(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "  \"balance\": xxxxxxx,         (numeric) the total grow balance of the wallet (excluding zerocoins)\n"
            ...
            "  \"zGROWsupply\" :\n"
            "  {\n"
            "     \"1\" : n,            (numeric) supply of 1 zGROW denomination\n"
            "     \"5\" : n,            (numeric) supply of 5 zGROW denomination\n"
            "     \"10\" : n,           (numeric) supply of 10 zGROW denomination\n"
            "     \"50\" : n,           (numeric) supply of 50 zGROW denomination\n"
            "     \"100\" : n,          (numeric) supply of 100 zGROW denomination\n"
            "     \"500\" : n,          (numeric) supply of 500 zGROW denomination\n"
            "     \"1000\" : n,         (numeric) supply of 1000 zGROW denomination\n"
            "     \"5000\" : n,         (numeric) supply of 5000 zGROW denomination\n"
            "     \"total\" : n,        (numeric) The total supply of all zGROW denominations\n"
            "  }\n"
    ...
    UniValue zgrowObj(UniValue::VOBJ);
    for (auto denom : libzerocoin::zerocoinDenomList) {
        zgrowObj.push_back(Pair(to_string(denom), ValueFromAmount(chainActive.Tip()->mapZerocoinSupply.at(denom) * (denom*COIN))));
    }
    zgrowObj.push_back(Pair("total", ValueFromAmount(chainActive.Tip()->GetZerocoinSupply())));
    obj.push_back(Pair("zGROWsupply", zgrowObj));
...
UniValue validateaddress(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "  \"address\" : \"growaddress\", (string) The grow address validated\n"
