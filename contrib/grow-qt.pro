...
RESOURCES += src/qt/grow.qrc src/qt/grow_locale.qrc

TRANSLATIONS += src/qt/locale/grow_bg.ts \
                src/qt/locale/grow_de.ts \
                src/qt/locale/grow_en.ts \
                src/qt/locale/grow_es.ts \
                src/qt/locale/grow_fi.ts \
                src/qt/locale/grow_fr.ts \
                src/qt/locale/grow_it.ts \
                src/qt/locale/grow_ja.ts \
                src/qt/locale/grow_pl.ts \
                src/qt/locale/grow_pt.ts \
                src/qt/locale/grow_ru.ts \
                src/qt/locale/grow_sk.ts \
                src/qt/locale/grow_sv.ts \
                src/qt/locale/grow_vi.ts \
                src/qt/locale/grow_zh_CN.ts \
                src/qt/locale/grow_zh_TW.ts
