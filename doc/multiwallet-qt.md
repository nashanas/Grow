...
In order to support loading of multiple wallets in grow-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is grow.cpp.
...
Changes to grow.cpp
----------------------
grow.cpp is the entry point into grow-qt, and as such, will require some minor modifications to provide hooks for
